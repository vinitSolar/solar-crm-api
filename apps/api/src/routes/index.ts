...
import { productSpecificationRoutes } from "../modules/product-specifications/index.js";
...
import { productCellTechnologyRoutes } from "../modules/product-cell-technologies/index.js";
...
apiRouter.use("/product-specifications", productSpecificationRoutes);
apiRouter.use("/product-brands", productBrandRoutes);
apiRouter.use("/product-units", productUnitRoutes);
apiRouter.use("/product-cell-technologies", productCellTechnologyRoutes);
